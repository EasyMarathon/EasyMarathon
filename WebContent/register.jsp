                  ...
                  <form data-validate="parsley" action="">
                    <section class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <div class="form-group">
                          <label>用户名</label>
                          <s:textfield cssClass="form-control" data-required="true"/>                        
                        </div>
                        <div class="form-group">
                          <label>邮箱</label>
                          <s:textfield cssClass="form-control" data-type="email" data-required="true"/>                        
                        </div>
                        <div class="form-group">
                          <label>联系方式</label>
                          <s:textfield cssClass="form-control" data-type="phone" placeholder="(XXX) XXXX XXX" data-required="true"/>
                        </div>
