                          ...
                          <ul  class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <a href="#" data-toggle="modal" data-target="#cloth1" class="thumb-lg pull-left m-r-sm">
                              ...
                              <a href="#" data-toggle="modal" data-target="#cloth1" class="clear">
                                <strong >女士运动腰包   跑步包   腰带手机包   马拉松多功能贴身户外用品</strong>
                                <br><br>
                                <small>包邮</small>
                                <small class="pull-right">杭州</small>
                                <br><br><br>
                                <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;136元</i>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
			 <img src="images/fashion/1.jpg" class="img-full">
         </div>
         <div class="modal-body">
         <strong >女士运动腰包   跑步包   腰带手机包   马拉松多功能贴身户外用品</strong><br>
		 <small>包邮</small>
		 <small class="pull-right">杭州</small>
		 <br><br>
		 <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;136元</i>
