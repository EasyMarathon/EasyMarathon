                        ...
                        <div class="pos-rlt">
                          <div class="item-overlay opacity r r-2x bg-black">
                            ...
                            <div class="bottom padder m-b-sm">
                              ...
                              <a href="#" data-toggle="modal" data-target="#myModa4">
                                <i class="icon-basket"></i>
                                <i class="fa fa-check-circle text-active text-info"></i>
                              </a>
                            </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
              <img src="PersonCenter/images/o7.jpg" class="img-full">
         </div>
         <div class="modal-body">设计者：	Allen JH ,价格：10元<br>
         <div class="checkbox i-checks">
			<label>
       			<input type="checkbox" name="check" checked data-required="true"><i></i>我同意遵守 <a href="#" class="text-info">《易跑平台照片购买条款》</a>
     		</label>
 		 </div>
         </div>
...
<div class="modal fade" id="myModa2" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
              <img src="PersonCenter/images/o2.jpg" class="img-full">
         </div>
         <div class="modal-body">设计者：	Amanda Conlan ,价格：10元<br>
         <div class="checkbox i-checks">
			<label>
       			<input type="checkbox" name="check" checked data-required="true"><i></i>我同意遵守 <a href="#" class="text-info">《易跑平台照片购买条款》</a>
     		</label>
...
<div class="modal fade" id="myModa3" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
              <img src="PersonCenter/images/o4.jpg" class="img-full">
         </div>
         <div class="modal-body">设计者：	Nisa Colen ,价格：10元<br>
         <div class="checkbox i-checks">
			<label>
       			<input type="checkbox" name="check" checked data-required="true"><i></i>我同意遵守 <a href="#" class="text-info">《易跑平台照片购买条款》</a>
     		</label>
...
<div class="modal fade" id="myModa4" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
              <img src="PersonCenter/images/o5.jpg" class="img-full">
         </div>
         <div class="modal-body">设计者：	Dan Doorack ,价格：10元<br>
         <div class="checkbox i-checks">
			<label>
       			<input type="checkbox" name="check" checked data-required="true"><i></i>我同意遵守 <a href="#" class="text-info">《易跑平台照片购买条款》</a>
     		</label>
