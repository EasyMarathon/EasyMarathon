...
%>
                 ...
                 <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                          <ul  class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <a href="#" data-toggle="modal" data-target="#cloth1" class="thumb-lg pull-left m-r-sm">
                                <img src="images/clothes/1.jpg" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#cloth1" class="clear">
                                <strong >迪卡侬 运动T恤女 马拉松跑步T恤 KALENJI</strong>
                                <br><br>
                                <small>包邮</small>
                                <small class="pull-right">广州</small>
                                <br><br><br>
                                <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;150元</i>
                            ...
                            <li  class="list-group-item">
                            <a href="#" data-toggle="modal" data-target="#cloth2" class="thumb-lg pull-left m-r-sm">
                                <img src="images/clothes/2.jpg" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#cloth2" class="clear">
                                <strong >迪卡侬  跑步运动速干t恤女  春夏短袖t恤女  速干t恤 KALENJI</strong>
                                <br><br>
                                <small>包邮</small>
                                <small class="pull-right">广州</small>
                                <br><br><br>
                                <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;129元</i>
								<small class="pull-right">
								<i class="fa fa-heart  text-danger"></i>
                                                                                                销量：0
								</small>
                            ...
                            <li  class="list-group-item">
                            <a href="#" data-toggle="modal" data-target="#cloth3" class="thumb-lg pull-left m-r-sm">
                                <img src="images/clothes/3.jpg" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#cloth3" class="clear">
                                <strong >迪卡侬  运动背心女  速干排湿超轻盈  专业跑步无袖T恤背心  KALENJI</strong>
                                <br><br>
                                <small>包邮</small>
                                <small class="pull-right">广州</small>
                                <br><br><br>
  ...
  <!-- 模态框（Moda1） -->
<div class="modal fade" id="cloth1" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
			 <img src="images/clothes/1.jpg" class="img-full">
         </div>
         <div class="modal-body">
         <strong >迪卡侬  运动T恤女 马拉松跑步T恤 KALENJI</strong><br>
		 <small>包邮</small>
		 <small class="pull-right">广州</small>
		 <br><br>
		 <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;150元</i>
...
<!-- 模态框（Moda2） -->
<div class="modal fade" id="cloth2" tabindex="-1" role="dialog" 
   aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="post-media">
			 <img src="images/clothes/2.jpg" class="img-full">
         </div>
         <div class="modal-body">
         <strong >迪卡侬   跑步运动速干t恤女  春夏短袖t恤女  速干t恤 KALENJI</strong><br>
		 <small>包邮</small>
		 <small class="pull-right">广州</small>
		 <br><br>
		 <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;150元</i>
...
<!-- 模态框（Moda3） -->
<div class="modal fade" id="cloth3" tabindex="-1" role="dialog" 
   aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="post-media">
			 <img src="images/clothes/3.jpg" class="img-full">
         </div>
         <div class="modal-body">
         <strong >迪卡侬   运动背心女 速干排湿超轻盈   专业跑步无袖T恤背心   KALENJI</strong><br>
		 <small>包邮</small>
		 <small class="pull-right">广州</small>
		 <br><br>
		 <i class="fa fa-rmb" style="color:#fb3504;">&nbsp;&nbsp;150元</i>
