...
<body class="">
<%
	ArrayList<FreePicBean> freePicList = (ArrayList<FreePicBean>)session.getAttribute("freePicList");
	ArrayList<FreePicBean> freePicListBySell = (ArrayList<FreePicBean>)session.getAttribute("freePicListBySell");
	ArrayList<FreePicBean> freePicListByTime = (ArrayList<FreePicBean>)session.getAttribute("freePicListByTime");
	
	String Path = request.getSession().getServletContext().getRealPath("/")+"UserPicture\\easyrun\\freePicture\\";	
...
%>
              ...
              <section class="vbox">
	              ...
	              <header class="header bg-light lt">
	                      <ul class="nav nav-tabs nav-white">
	                        ...
	                        <li class="" style="width:33.33%;text-align:center"><a href="#interaction" data-toggle="tab">时间优先</a></li>
	                      </ul>
	              </header>
                 ...
                 <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                          <ul  class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <a href="#" data-toggle="modal" data-target="#l<%=i %>" class="thumb-lg pull-left m-r-sm">
                            <%	String basePath = "UserPicture/freePicture/"+freePicList.get(i).getEventID()+"/"+freePicList.get(i).getPicID();
                            	//System.out.println("图片路径="+basePath);
                            %>
                                <img src="<%=basePath%>" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#l<%=i %>" class="clear">
                                <small class="pull-right">
                                	<i class="fa fa-heart  text-danger"></i>
                                	人气：<%=freePicList.get(i).getDownloadCnt() %>
                                </small>
                                <strong >上传者&nbsp;&nbsp;</strong>
                                <%if(freePicList.get(i).getUserName()==null){ %>
                                	<small>未知</small>
                                <%}else{%>
                                	<small><%=freePicList.get(i).getUserName()%></small>
                                <%}%>
                                <br><br>
                                <strong class="block">拍摄地点</strong>
                                <small><%=freePicList.get(i).getEventName()%>&nbsp;&nbsp;</small>
                                <br><br><br><i class="fa fa-fire" style="color:#fb3504;">&nbsp;&nbsp;5积分</i>
                        ...
                        <div class="tab-pane" id="events"><!-- 销量优先页面 -->
                          ...
                          <ul  class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <%for(int i=0;i<freePicListBySell.size();i++){ %>
                            <li  class="list-group-item">
                            <a href="#" data-toggle="modal" data-target="#<%=i %>" class="thumb-lg pull-left m-r-sm">
                            <%	String basePath = "UserPicture/freePicture/"+freePicListBySell.get(i).getEventID()+"/"+freePicListBySell.get(i).getPicID();
                            %>
                                <img src="<%=basePath%>" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#<%=i %>" class="clear">
                                <small class="pull-right">
                                	<i class="fa fa-heart  text-danger"></i>
                                	人气：<%=freePicListBySell.get(i).getDownloadCnt() %>
                                </small>
                                <strong >上传者&nbsp;&nbsp;</strong>
                                <%if(freePicListBySell.get(i).getUserName()==null){ %>
                                	<small>未知</small>
                                <%}else{%>
                                	<small><%=freePicListBySell.get(i).getUserName()%></small>
                                <%}%>
                                <br><br>
                                <strong class="block">拍摄地点</strong>
                                <small><%=freePicListBySell.get(i).getEventName()%>&nbsp;&nbsp;</small>
                                <br><br><br><i class="fa fa-fire" style="color:#fb3504;">&nbsp;&nbsp;5积分</i>
								<small class="pull-right">…</small>
                              </a>
                            </li>
                        ...
                        <div class="tab-pane" id="interaction"><!-- 上传时间优先页面 -->
                          ...
                          <ul  class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <%for(int i=0;i<freePicListByTime.size();i++){ %>
                            <li  class="list-group-item">
                            <a href="#" data-toggle="modal" data-target="#<%=i %>" class="thumb-lg pull-left m-r-sm">
                            <%	String basePath = "UserPicture/freePicture/"+freePicListByTime.get(i).getEventID()+"/"+freePicListByTime.get(i).getPicID();
                            %>
                                <img src="<%=basePath%>" >
                              </a>
                              <a href="#" data-toggle="modal" data-target="#<%=i %>" class="clear">
                                <small class="pull-right">
                                	<i class="fa fa-heart  text-danger"></i>
                                	人气：<%=freePicListByTime.get(i).getDownloadCnt() %>
                                </small>
                                <strong >上传者&nbsp;&nbsp;</strong>
                                <%if(freePicListByTime.get(i).getUserName()==null){ %>
                                	<small>未知</small>
                                <%}else{%>
                                	<small><%=freePicListByTime.get(i).getUserName()%></small>
                                <%}%>
                                <br><br>
                                <strong class="block">拍摄地点</strong>
                                <small><%=freePicListByTime.get(i).getEventName()%>&nbsp;&nbsp;</small>
                                <br><br><br><i class="fa fa-fire" style="color:#fb3504;">&nbsp;&nbsp;5积分</i>
								<small class="pull-right">…</small>
                              </a>
                            </li>
  ...
  <!-- 模态框（Moda4） -->
<%for(int i=0;i<freePicList.size();i++){ %>
<div class="modal fade" id="l<%=i %>" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="post-media">
	         <%	String basePath = "UserPicture/freePicture/"+freePicList.get(i).getEventID()+"/"+freePicList.get(i).getPicID();
			 %>
			 <img src="<%=basePath%>" class="img-full">
         </div>
         ...
         <%if(freePicList.get(i).getUserName()==null){ %>
            	 未知
         <%}else{%>
		 <%=freePicList.get(i).getUserName()%>
		 <%}%><br>
		 拍摄地点：<%=freePicList.get(i).getEventName()%>
		 <i class="fa fa-fire pull-right" style="color:#fb3504;">&nbsp;&nbsp;5积分</i>
		 <br>
		 <br>
