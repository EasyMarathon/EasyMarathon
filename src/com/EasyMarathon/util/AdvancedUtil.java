...
import com.EasyMarathon.bean.WeixinGroup;
import com.EasyMarathon.bean.WeixinMedia;
import com.EasyMarathon.bean.WeixinQRCode;
import com.EasyMarathon.bean.WeixinUserInfo;
import com.EasyMarathon.bean.WeixinUserList;
	...
	public static WeixinUserInfo getUserInfo(String accessToken, String openId)
	{
		...
		if (null != jsonObject)
		{
			try
			{
				...
				// 用户关注时间
				weixinUserInfo.setSubscribeTime(
			...
			String nextOpenId)
	{
		...
		if (null != jsonObject)
		{
			try
			{
				...
				weixinUserList
						.setNextOpenId(jsonObject.getString("next_openid"));
			...
			catch (JSONException e)
			{
				...
				int errorCode = jsonObject.getInt("errcode");
				String errorMsg = jsonObject.getString("errmsg");
				log.error("获取关注者列表失败 errcode:{} errmsg:{}", errorCode,
						errorMsg);
			}
		}
		return weixinUserList;
	...
	public static WeixinGroup createGroup(String accessToken, String groupName)
	{
		...
		if (null != jsonObject)
		{
			try
			{
				...
				weixinGroup
						.setId(jsonObject.getJSONObject("group").getInt("id"));
				weixinGroup.setName(
